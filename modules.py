...
def generar_noticia(transcripcion, X, Y, Z, A, B):
    ...
    messages = [
        ...
        {"role": "user", "content": "Recuerda que debes devolverme el texto con etiquetas de html para que la noticia sea más visual, utilizando todo lo necesario para destacar el contenido: titulos (h1, h2, h3...), negritas (<b>, <strong>), cursivas (<em>, <i>), subrayados (<u>), etc."},
    ]
